"use client"
import { sendForgetPasswordOTP } from '@/lib/actions/auth'
...
export default function Page() {
    ...
    const [state, formAction, isLoading] = useActionState(sendForgetPasswordOTP, prevState)

    const router = useRouter()

    useEffect(() => {
        if (state.success) {
            toast.success("OTP sent, Check you mail")
            router.replace("/verify-password-otp")
        } else if (state.error) {
            ...
            <div className="container mx-auto px-6">
                ...
                <div className="flex justify-center sand-500">
                    <div className="w-full md:w-5/12 py-10">
                        ...
                        <div className="text-sm mb-4">Forgotten your password? No proplem, input your email and click the button below to receive OTP</div>
                        <div className="text-xs mb-5 font-bold">Tip: Use an email you have access to</div>
